...
const PersistentNav: React.FC<PersistentNavProps> = ({ children }) => {
  const { logout } = useAuth();
  const { notificationCount, messageCount, clearNotifications, clearMessages } = useNotifications();
    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="h-16 px-4 flex items-center justify-between" style={{ backgroundColor: '#09D0EF' }}>
        ...
        <div className="flex-1 flex justify-center">
          <Link to="/search-coming-soon" className="flex items-center space-x-2 px-4 py-2 bg-white bg-opacity-20 hover:bg-opacity-30 rounded-full transition-colors text-black">
